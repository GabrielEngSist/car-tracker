...
namespace Car.Tracker.Domain.Integration.Wire;

/// <summary>
/// JSON payload for external consultarPrecoFipe API (wire format).
/// </summary>
...
public sealed class ConsultarPrecoFipeDadosRoot
{
    ...
    public List<ConsultarPrecoFipeInformacaoFipe>? InformacoesFipe { get; set; }
}
...
public sealed class ConsultarPrecoFipeInformacaoFipe
{
